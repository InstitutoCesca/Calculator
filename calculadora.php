...
{ /*Comprobamos que estamos trabajando con un numero entero, ya que */
	/*Si ya es decimal npo hya que ponerle otro punto decimal */
	/*Si numnero - su entero = 0 => no e sdecimal */
	$pantalla=$pantalla.".";
}
if(isset($igual)) /* Aqui entrara si le hemos dado igual */
{
unset($nuevaop); /* Una vez que le demos igual, el siguiente numero*/
/*Intreoducido sera una nueva operacion, por lo tanto*/
...
/* Despues de adrle al igual, y comenzar una nueva operación, escribir un */
...
{ /* igual o al punto decimal */
	...
	else
	{
		...
		} /* es igual escrito, si no se cree que */
		else /* 0. = 0 */
		{
